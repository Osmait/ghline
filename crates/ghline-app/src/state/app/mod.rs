...
pub struct App {
    ...
    pub finder_source: crate::data::Source,
...
impl App {
    ...
    pub fn new(service: Option<Box<dyn Worker<Request, Response>>>) -> Self {
        Self {
            ...
            acc_sel: 0,
            finder_open: false,
            finder_source: crate::data::Source::Repos,
    ...
    fn worker_died(&mut self) {
        ...
        self.service = None;
        let gone = || Load::refused("the worker thread is gone — restart ghline");
        for st in [
        ...
        self.flash_warn("the worker thread is gone — restart ghline");
    }
