    ...
    rows.iter()
        ...
        .map(|(i, (num, title, state, checks, author, when, branch))| {
            ...
            if i == 0 {
                ...
                d.reviews = vec![
                    Review {
                        author: "noa-example".into(),
                        state: ReviewState::ChangesRequested,
                    },
                    Review {
                        author: "iris-example".into(),
...
pub fn raw_log() -> Vec<RawLog> {
    ...
    vec![
        line(
            ...
            "checkout",
            1,
            "Syncing repository: ada-example/tuikit",
            LogKind::Plain,
        ),
        line(
            "build",
