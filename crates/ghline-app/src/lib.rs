//! ghline: repositories, issues, pull requests and Actions, over `gh`.
//!
...
/// Application configuration and services shared with `diffline`.
pub use line_shared as shared;
/// Terminal drawing primitives shared with `diffline`.
