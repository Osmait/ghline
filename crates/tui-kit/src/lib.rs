...
//! to neither: these lived in `ui`, which is ghline's, and diffline
...
//! | [`key`] | terminal-independent keys, mouse events and replay notation |
//! | [`theme`] | the palette |
//! | [`run`] | the terminal and its event loop |
//! | [`probe`] | reading a drawn frame back, for tests |
//! | [`svg`] | exporting a drawn frame for headless renderers |
//!
