...
/// do not share an accent: diffline's modals are yellow and ghline's are
...
/// how ghline's finder ended up with its own copy of these twenty lines.
...
///
/// One answer, where there were two. ghline drew a distinct glyph per
