...
///
/// ```rust
/// use tui_kit::geom::scroll_into_view;
///
/// let mut offset = 0;
...
/// reading, ghline's cover a list you are done with.
///
...
///
/// ```rust
/// use tui_kit::geom::{centered, centered_over};
/// use ratatui::layout::{Rect, Size};
///
