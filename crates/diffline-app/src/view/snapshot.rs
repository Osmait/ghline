...
//!
//! ghline has had one of these since the design was ported, and its
...
use crate::model::{ChangedFile, Comment, Kind, Row, Scope, State, Status};
...
/// reason ghline's fixture sets it — a cursor is on in half the frames it
...
/// on, so nothing in here can fail. See the twin in `ghline_app::view::snapshot`
