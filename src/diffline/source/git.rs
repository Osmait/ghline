...
impl crate::diffline::vcs::Vcs for Git {
    ...
    for line in text.lines() {
        if line.starts_with("@@") {
            ...
            out.push(Row {
                ...
                text: crate::shared::text::expand_tabs(line).into_owned(),
            });
            continue;
        }
        if !started {
        ...
        out.push(Row {
            ...
            text: crate::shared::text::expand_tabs(text).into_owned(),
        });
    }
    out
}
