//! The `github-tui` adapter driven by the shared terminal loop.
//!
...
use github_tui::tui::run::{Handover, Program};

use github_tui::github::app::App;
use github_tui::github::service::{Request, Response, Service};
use github_tui::github::ui;
use github_tui::shared::worker::Worker;
...
/// github-tui's state and the timers its terminal runtime advances.
pub(super) struct GithubTui {
    app: App,
    tick: Instant,
    blink: Instant,
    anim: Instant,
