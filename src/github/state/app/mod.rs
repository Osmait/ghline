...
use self::hit::Region;
use crate::github::actions::{Flash, Prompt};
use std::sync::Arc;
...
pub enum Dest {
    ...
    Running(crate::shared::mux::Agent),
...
impl Dest {
    ...
    pub fn refusal(&self) -> Option<String> {
        match self {
            ...
            Self::Running(a) if !crate::shared::mux::current().is_free(a) => Some(format!(
...
pub struct App {
    ...
    pub theme_sel: usize,
    pub theme_before: crate::shared::theme::Theme,
    pub help_open: bool,
    pub cmd: Option<Cmd>,
    pub cmd_text: String,
    pub filter: String,
    ...
    pub agents: Vec<crate::shared::mux::Agent>,
    pub agents_state: Load,
    /// A repository's file tree, keyed by `owner/repo`.
    pub trees: HashMap<String, Vec<crate::github::data::TreeEntry>>,
    ...
    pub file_spans: HashMap<(String, String), Vec<Vec<crate::shared::syntax::Span>>>,
    ...
    pub clones: crate::shared::clones::Index,
...
impl App {
    pub fn new(source: Source) -> Self {
        ...
        Self {
            ...
            acc_sel: 0,
            finder_open: false,
            finder_source: crate::github::finder::Source::Repos,
            ...
            themes_open: false,
            theme_sel: 0,
            theme_before: crate::shared::theme::current(),
            help_open: false,
            cmd: None,
            cmd_text: String::new(),
            filter: String::new(),
