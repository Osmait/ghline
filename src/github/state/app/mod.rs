...
pub struct App {
    ...
    pub finder_source: crate::github::data::Source,
    ...
    pub theme_sel: usize,
    pub theme_before: crate::tui::theme::Theme,
    pub help_open: bool,
    pub cmd: Option<Cmd>,
    pub cmd_text: String,
    pub filter: String,
...
impl App {
    ...
    pub fn new(source: Source, service: Option<Box<dyn Worker<Request, Response>>>) -> Self {
        ...
        Self {
            ...
            acc_sel: 0,
            finder_open: false,
            finder_source: crate::github::data::Source::Repos,
            ...
            themes_open: false,
            theme_sel: 0,
            theme_before: crate::tui::theme::current(),
            help_open: false,
            cmd: None,
            cmd_text: String::new(),
            filter: String::new(),
