//! The command line of `github-tui`, separate from starting either renderer.
//!
...
/// What `github-tui` should do after its command line has been parsed.
...
/// Parses `github-tui` arguments without starting any application service.
